...
const admin_id = process.env.ADMIN_ID || config.admin_id
...
const datamall_od_bus_folder_id = process.env.DATAMALL_OD_BUS_FOLDER_ID || config.datamall_bus_folder_id;
const datamall_od_train_folder_id = process.env.DATAMALL_OD_TRAIN_FOLDER_ID || config.datamall_train_folder_id;
...
module.exports = {
  token, discord_client_id, discord_guild_id, admin_id, datamall_api_key_1, datamall_api_key_2, drive_client_id, drive_client_secret, drive_redirect_URI,
  datamall_od_bus_folder_id, datamall_od_train_folder_id, datamall_spec_bus_folder_id, datamall_spec_train_folder_id,
  drive_token_path, services_folder_id, stops_folder_id, registry_file_id, copypastas_file_id, points_file_id, discord_port, proxy_port
};